...
int main(){
   ...
   cout << "insertAfter insertBefore test";
   cout << endl;
   cout << "A = " << A << endl;
   ...
   cout << "moveBack moveFront test" << endl;
   cout << "A = " << A << endl;
   cout << "A.position() = " << A.position() << endl;
   cout << "B = " << B << endl;
   cout << "B.position() = " << B.position() << endl;
   ...
   cout << "findNext findPrev eraseBefore eraseAfter test" << endl;
   ...
   cout << "pass List to List test" << endl;
   List E = A;
   cout << "E==A is " << (E==A?"true":"false") << endl;

   cout << endl;

   cout << "concat peekNext peekPrev test" << endl;
   List F = A.concat(B);
   cout << "F = " << F << endl;
